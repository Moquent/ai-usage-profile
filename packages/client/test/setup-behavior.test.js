...
describe("setup behavior", () => {
  ...
  it("throws when credentials cannot be resolved without device login", async () => {
    await expect(resolveGitHubCredentials({ env: {}, createAuth: () => async () => { throw new Error("device failed"); } }))

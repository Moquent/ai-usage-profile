...
- **GitHub validation cache:** During publish, your token is verified with GitHub and remembered in memory for up to 30 seconds (hashed key, not stored in the database).
